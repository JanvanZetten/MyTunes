...
public class LocalDAO implements DAO
{
    ...
    public List<Playlist> getAllPlaylists() throws DALException
    {
        ...
        {
            throw new DALException("Reading local playlists: " + ex.getMessage(), ex.getCause());
        }
    }
    ...
    public List<Song> getAllSongs() throws DALException
    {
        ...
        {
            throw new DALException("Reading local songs: " + ex.getMessage(), ex.getCause());
        }
    }
    ...
    public List<Genre> getAllGenres() throws DALException
    {
        ...
        {
            throw new DALException("Reading local genres: " + ex.getMessage(), ex.getCause());
        }
    }
